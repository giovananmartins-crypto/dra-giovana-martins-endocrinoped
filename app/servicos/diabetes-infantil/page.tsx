              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <WhatsAppLink href="https://wa.me/5531972648155" target="_blank" rel="noopener noreferrer" label="Diabetes Infantil - Hero">
            ...
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  asChild
                >
                  <PhoneLink href="tel:+5531972648155" label="Diabetes Infantil - CTA">
                ...
                <Button
                  ...
                  asChild
                >
                  <WhatsAppLink href="https://wa.me/5531972648155" target="_blank" rel="noopener noreferrer" label="Diabetes Infantil - CTA">
                    <MessageCircle className="h-5 w-5" />
                    WhatsApp
                  </WhatsAppLink>
                </Button>
